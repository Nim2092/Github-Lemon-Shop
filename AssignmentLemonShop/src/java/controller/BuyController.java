...
public class BuyController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        cartItemDAO.addCartItem(cart.getCartId(), Integer.parseInt(id));
        List<CartItem> listcid = cartItemDAO.getAllCartItemsByCartId(cart.getCartId());
        int count=listcid.size();
        
        PrintWriter out = response.getWriter();
        request.setAttribute("aid", aid);
        request.setAttribute("count1", count);
        request.setAttribute("list",listcid);
